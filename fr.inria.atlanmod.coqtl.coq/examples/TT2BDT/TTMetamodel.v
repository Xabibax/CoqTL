...
Definition getPortName (p : Port) : string :=
  match p with BuildPort name isInputPort  => name end.
Definition getPortIsInputPort (p : Port) : bool :=
  match p with BuildPort name isInputPort  => isInputPort end.
...
Definition TruthTableModelMetamodel_getEObjectFromEAttributeValues (trec_arg : TruthTableModelMetamodel_EClass) : (TruthTableModelMetamodel_getEAttributeTypesByEClass trec_arg) -> TruthTableModelMetamodel_EObject :=
  match trec_arg with
    ...
    | PortEClass => (fun (p: (string * bool)) => (Build_TruthTableModelMetamodel_EObject PortEClass (BuildPort (fst p) (snd p))))
  end.
...
Definition TruthTableModelMetamodel_getName (a : TruthTableModelMetamodel_EObject) : string.
Proof.
  destruct a.
  destruct trec_arg.
  * simpl in t. exact (getTruthTableName t).
  * simpl in t. exact (getRowName t).
  * simpl in t. exact (getCellName t).
  * simpl in t. exact (getPortName t).
Defined.
Definition TruthTableModelMetamodel_setName (a : TruthTableModelMetamodel_EObject) (s: string) : TruthTableModelMetamodel_EObject.
Proof.
  destruct a.
  destruct trec_arg.
  * simpl in t. exact (setTruthTableName t s).
  * simpl in t. exact (setRowName t s).
  * simpl in t. exact (setCellName t s).
  * simpl in t. exact (setPortName t s).
...
Instance TruthTableModelMetamodel : Metamodel TruthTableModelMetamodel_EObject TruthTableModelMetamodel_ELink TruthTableModelMetamodel_EClass TruthTableModelMetamodel_EReference :=
  {
    ...
    getId := TruthTableModelMetamodel_getName;
    setId := TruthTableModelMetamodel_setName;
  }.
